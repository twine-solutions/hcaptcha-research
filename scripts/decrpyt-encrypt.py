...
class hCaptcha:
    ...
    def __init__(self, version: str = "6c2596db2ce08d2f8763801d158624c790db3d34b0235bb33999fd85979fac64") -> None:
        self.key_chain = {
            ...
            "d1285730e6df7d9e9b8c090abc80b36cbbf8722e3655a8d303e084cc7824831a": [208, 37, 218, 11, 6, 85, 42, 133] # I'll let you find these ones. (But there is the start of it as a hint.)
        }
